...
def HTTP_Request(endPoint,method,payload,Info):
    ...
    try:
        ...
        print(json.dumps(data, indent=4)) #Print the parsed JSON with indentation for readability.
    except json.JSONDecodeError as e:
        print(f"Error decoding JSON response: {e}")
        print(response.text) #Print raw response if JSON parsing fails.
...
method="POST"
params='{"orderId":"1878418210397523968"}'
